...
Important instructions:
- required_skills: extract only concrete technical skills, technologies,
  frameworks, libraries, programming languages, platforms, AI/ML concepts,
  or tools explicitly stated as required or must-have.
- preferred_skills: extract only concrete technical skills, technologies,
  frameworks, libraries, programming languages, platforms, AI/ML concepts,
  or tools explicitly stated as preferred, nice-to-have, or bonus.
- keywords: extract only concrete technical skills, technologies,
  frameworks, libraries, platforms, tools, programming languages,
  AI/ML concepts, certifications, and specific domain terms.
- Do NOT include generic words or phrases such as:
  experience, knowledge, understanding, ability, responsibilities,
  requirements, candidate, team, communication, problem-solving,
  AI Engineer Intern, or similar role/title phrases.
- Do NOT include generic phrases such as "AI applications",
  "basic understanding", "working knowledge", or "experience with"
  unless the phrase contains a specific technical skill.
- Each keyword should represent a concrete skill or technical/domain concept,
  not a sentence or generic requirement.
- Return ONLY valid JSON. No markdown code fences, no explanation.
