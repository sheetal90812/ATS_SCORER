...
from backend.services.skill_normalizer import normalize_skills, filter_jd_skills
...
def analyze_full_resume(
    ...
    skills = normalize_skills(parsed_resume.get('skills', []))
    print("DEBUG RESUME SKILLS:", skills)
    
    projects = parsed_resume.get('projects', [])
    print("\nDEBUG PROJECTS:")
    for project in projects:
        print(project)
    keywords = normalize_skills(parsed_resume.get('keywords', []))
    ...
    print("DEBUG validated_raw:", validated_raw)
    print("DEBUG unvalidated_raw:", unvalidated_raw)
